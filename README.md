...
How do we connect all of these units to this fully connected layer?This is a vector of 50 units.how we go from macpool2(20X5X5)shape to fc1(1X50)shape?the answewr is we just linearize the output of the maxpool.we have 10 units in the output layer because this is the most digits data set, so there are 10 categories in total.
